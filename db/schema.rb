...
ActiveRecord::Schema.define(version: 20150927011205) do
  ...
  add_index "artworks", ["slug"], name: "index_artworks_on_slug", unique: true, using: :btree
  ...
  create_table "webhook_invocations", force: true do |t|
